...
pathLocation = (
    r"C:\Users\alexp\Documents\UW\Research\Selenium\Coplanar Detector\sim_data"
)
...
for i, file in enumerate(os.listdir(pathLocation)):
    ...
    qA, qB, qDiff = plot.inducedCharge(
        data[:, (1, 2, 6)], data[:, (1, 2, 9)], pos, method="linear"
    )
...
ax.set_title(
    r"Induced Charge vs Depth for a 2000x2000x2000 $\mu m$ Coplanar Electrode with Different Finger Spacing",
    fontsize=16,
)
