...
filelist = [
    "kapton_layer_analysis_1um_spacing_fullsize.txt",
...
for findx, file in enumerate(filelist):
    ...
    ax5.plot(
        ...
        "k:",
        -z,
        wPhiAReshape[:, yIndx] - wPhiBReshape[:, yIndx],
        "k",
        linewidth=3,
    )
    ax5.plot(
        -z,
        phiBSlice * slopeA / slopeB,
        "r:",
        -z,
        phiASlice - phiBSlice * slopeA / slopeB,
        "r",
        linewidth=3,
    )
    ...
    ax5.set_title(
        "Y Slice of Weighted Potential and Difference for " + spacingText, fontsize=16
    )
